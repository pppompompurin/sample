...
public class SampleController {
	...
	public List<SampleVO> getList() {
		...
		return IntStream.range(1, 10).mapToObj(i -> new SampleVO(i, i + "상혀기몽총이", i + "뚜비니최곡"))
	...
	public Map<String, SampleVO> getMap() {
		...
		map.put("First", new SampleVO(111, "뚜비니", "쥬쥬시크릿"));
	...
	public String[] getPath(
		...
		return new String[] { "category: " + cat, "poductid: " + pid };
	}
